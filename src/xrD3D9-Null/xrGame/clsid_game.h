...
// Game types
#define CLSID_SV_eGameIDSingle			MK_CLSID('S','V','_','S','I','N','G','L')
#define CLSID_SV_eGameIDDeathmatch		MK_CLSID('S','V','_','D','M',' ',' ',' ')
#define CLSID_SV_eGameIDTeamDeathmatch	MK_CLSID('S','V','_','T','D','M',' ',' ')
#define CLSID_SV_eGameIDArtefactHunt		MK_CLSID('S','V','_','A','H','U','N','T')
//#define CLSID_GAME_CS				MK_CLSID('S','V','_','C','S',' ',' ',' ')
#define CLSID_CL_eGameIDSingle			MK_CLSID('C','L','_','S','I','N','G','L')
#define CLSID_CL_eGameIDDeathmatch		MK_CLSID('C','L','_','D','M',' ',' ',' ')
#define CLSID_CL_eGameIDTeamDeathmatch	MK_CLSID('C','L','_','T','D','M',' ',' ')
#define CLSID_CL_eGameIDArtefactHunt		MK_CLSID('C','L','_','A','H','U','N','T')

...
//	return (GameID() == eGameIDSingle) ? ALife::eHitTypeStrike;
}//
...
void CPHMovementControl::SetVelocity(float x, float y, float z)
{
	SetVelocity(Fvector().set(x, y, z)); 
}

void CPHMovementControl::SetVelocity(const Fvector& v)
{
	vVelocity.set(v); 

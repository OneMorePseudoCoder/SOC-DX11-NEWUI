...
void CObjectFactory::register_classes	()
{
	...
	//Server Game type
	add<game_sv_Single>											(CLSID_SV_eGameIDSingle			,"game_sv_single");
	add<game_sv_Deathmatch>										(CLSID_SV_eGameIDDeathmatch		,"game_sv_deathmatch");
	add<game_sv_TeamDeathmatch>									(CLSID_SV_eGameIDTeamDeathmatch	,"game_sv_team_deathmatch");
	add<game_sv_ArtefactHunt>									(CLSID_SV_eGameIDArtefactHunt		,"game_sv_artefact_hunt");
	//Client Game type
	add<game_cl_Single>											(CLSID_CL_eGameIDSingle			,"game_cl_single");
	add<game_cl_Deathmatch>										(CLSID_CL_eGameIDDeathmatch		,"game_cl_deathmatch");
	add<game_cl_TeamDeathmatch>									(CLSID_CL_eGameIDTeamDeathmatch	,"game_cl_team_deathmatch");
	add<game_cl_ArtefactHunt>									(CLSID_CL_eGameIDArtefactHunt		,"game_cl_artefact_hunt");

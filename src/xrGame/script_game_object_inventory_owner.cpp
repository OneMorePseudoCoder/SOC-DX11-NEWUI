...
void _give_news(LPCSTR caption, LPCSTR news, LPCSTR texture_name, Frect tex_rect, int delay, int show_time, int type);

void  CScriptGameObject::GiveGameNews(LPCSTR caption, LPCSTR news, LPCSTR texture_name, Frect tex_rect, int delay, int show_time)
{
	GiveGameNews(caption, news, texture_name, tex_rect, delay, show_time, 0);
}

void  CScriptGameObject::GiveGameNews(LPCSTR caption, LPCSTR news, LPCSTR texture_name, Frect tex_rect, int delay, int show_time, int type)
{
	_give_news(caption, news, texture_name, tex_rect, delay, show_time, type);
}

void _give_news(LPCSTR caption, LPCSTR text, LPCSTR texture_name, Frect tex_rect, int delay, int show_time, int type)
{

...
//		.def("set_sight",					(void (CScriptGameObject::*)(const MemorySpace::CMemoryInfo *memory_object, bool	torso_look))(&CScriptGameObject::set_sight))
		...
		.def("give_game_news",				(void (CScriptGameObject::*)(LPCSTR, LPCSTR, LPCSTR, Frect, int, int))(&CScriptGameObject::GiveGameNews))
		.def("give_game_news",				(void (CScriptGameObject::*)(LPCSTR, LPCSTR, LPCSTR, Frect, int, int, int))(&CScriptGameObject::GiveGameNews))
